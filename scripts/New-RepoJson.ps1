...
$entry = [ordered]@{
    Author                 = "LonelyFSH"
    Name                   = "MarketRoute CN"
    Punchline              = "国服全品类批量比价、路线优化与采购会话。"
    Description            = "面向 FF14 国服交易板的批量采购规划插件。支持多个采购清单、任意/HQ/NQ 条件、四大区完整报价比较、完整挂单组合、最低价/平衡/最少服务器路线策略、报价历史、采购会话与中断恢复，并显示查询时间和市场数据时间。价格来自 Universalis 众包数据。"
